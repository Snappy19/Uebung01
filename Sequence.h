...
Sequence<Alpha> Sequence<Alpha>::fromString(const std::string& str)
{
	...
	// wir bekommen string -> auslesen char für char und in jeweiligen Character umwandeln (DNA??)
	// ist vermutlich kompletter Schwachsinn hier

	Sequence<Alpha> res = new Sequence();

	for (auto it = str.begin(); it < str.end(); it++ ) {

		auto a = Alphabet::DNA::toCharacter(it);
		res.add(a);
	}
...
{
	return "string: " + this;			// 100 pro falsch
	// assert("Not implemented" && false);
}

/*
template <typename Alpha>
iterator Sequence<Alpha>::begin() {
}
*/

template <typename Alpha>
size_t Sequence<Alpha>::size() const
{
	return this->length();		// auch hier kp ob das so geht
}

template <typename Alpha>
void Sequence<Alpha>::clear()
{
		for (auto it = this->begin(); it < this->end(); it++)
		{
			~it;		// kp ob das so geht
		}
}

template <typename Alpha>
void Sequence<Alpha>::resize(size_t i)
{
	// TODO: Implement
}

template <typename Alpha>
void Sequence<Alpha>::reserve(size_t i)
{
	// TODO: Implement
}

template <typename Alpha>
void Sequence<Alpha>::push_back(Characters c)
{
	// TODO: Implement
}

template <typename Alpha>
const std::string& Sequence<Alpha>::getComment() const
{
	return comment_;
}
...
template <typename Alpha>
bool Sequence<Alpha>::compare(const Sequence& seq, size_t i) const
{
	// an stelle i in der ersten sequenz springen (this) und dann beide (mit iterator?) vergleichen
	// oder einfach als objekte vergleichen
	return false;
}
...
{
	// ende der ersten sequenz (this) nehmen und mit anfang seq vergleichen
	// vielleicht char für char vom ende aus anfangen und mit entsprechender anzahl an char
	// der zweiten seq vergleichen?
	// mit for schleife
	return 0;
}
/*
...
template <typename Alpha>
std::map<Characters, size_t> Sequence<Alpha>::statistics() const
{
	// TODO: Implement
}
*/
/*
template <typename Characters>
Characters& Sequence<Alpha>::operator[](size_t i)
{
...
/*
template <typename Alpha>
Characters Sequence<Alpha>::operator[](size_t i) const
{
	return this[i];
}
*/
...
template <typename Alpha>
bool Sequence<Alpha>::operator==(const Sequence&) const
{
	return false;
}
...
/*
template <typename A>
std::ostream& operator<<(std::ostream&, const Sequence<A>&)
{
	// TODO: Implement
}

template <typename A>
std::istream& operator>>(std::istream&, Sequence<A>&)
{
	// TODO: Implement
}
 */